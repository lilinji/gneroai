...
export function GuidesIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
    ...
    >
      ...
      <path d="M9 9h6v2H9V9zm0 4h6v2H9v-2zm0 4h4v2H9v-2z" />
    </svg>
  );
}
...
export function WeChatIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      ...
      role="img"
      aria-label="微信"
      style={{ color: props.style?.color || '#07c160', ...props.style }}
      {...props}
    >
      <path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55L2.441 16.75c-.293.668.349 1.377 1.02.99l2.888-1.667c1.17.293 2.49.389 3.893.389.579 0 1.156-.049 1.734-.146-.146-.469-.244-.957-.244-1.469 0-3.208 2.734-5.82 6.063-5.82.489 0 .977.049 1.416.146C17.639 4.203 13.748 2.188 8.691 2.188zm-2.293 3.748c.586 0 1.073.489 1.073 1.073s-.487 1.073-1.073 1.073-1.073-.487-1.073-1.073.487-1.073 1.073-1.073zm4.683 0c.586 0 1.073.489 1.073 1.073s-.487 1.073-1.073 1.073-1.073-.487-1.073-1.073.487-1.073 1.073-1.073z"/>
      <path d="M18.359 11.563c-3.183 0-5.732 2.096-5.732 4.683 0 .879.293 1.707.781 2.388l-1.658 2.388c-.195.488.244.976.683.78l2.341-1.17c.439.098.928.146 1.415.146 3.208 0 5.732-2.096 5.732-4.683s-2.524-4.683-5.732-4.683zm-3.403 2.733c.342 0 .634.293.634.634s-.293.634-.634.634-.634-.293-.634-.634.293-.634.634-.634zm2.489 0c.342 0 .634.293.634.634s-.293.634-.634.634-.634-.293-.634-.634.293-.634.634-.634z"/>
    </svg>
  );
}

export function WeiboIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      ...
      role="img"
      aria-label="微博"
      style={{ color: props.style?.color || '#E6162D', ...props.style }}
      {...props}
    >
      <path d="M10.098 20.323c-3.977.391-7.414-1.406-7.672-4.02-.259-2.609 2.759-5.047 6.74-5.441 3.979-.394 7.413 1.404 7.671 4.018.259 2.6-2.759 5.049-6.739 5.443zm.652-7.919c-2.671.293-4.746 2.317-4.635 4.524.111 2.207 2.391 3.765 5.062 3.472 2.671-.293 4.746-2.317 4.635-4.524-.111-2.207-2.391-3.765-5.062-3.472zm-.326 6.401c-.652.069-1.239-.293-1.31-.809-.07-.516.377-.995 1.029-1.064.652-.069 1.239.293 1.31.809.07.516-.377.995-1.029 1.064zm1.239-1.516c-.264.033-.5-.118-.53-.327-.029-.209.15-.403.414-.436.264-.033.5.118.53.327.029.209-.15.403-.414.436z"/>
      <path d="M19.659 9.18c-.326-.978-1.174-1.826-2.391-2.391-.5-.234-.913-.111-1.065.326-.152.436.07.934.57 1.17.87.406 1.435 1.283 1.239 2.369-.111.652.234 1.217.848 1.283.652.069 1.17-.436 1.283-1.065.152-.913-.152-1.826-.484-2.692z"/>
      <path d="M17.5 7.5c0-.828-.672-1.5-1.5-1.5s-1.5.672-1.5 1.5.672 1.5 1.5 1.5 1.5-.672 1.5-1.5zm3-1.5c0-.828-.672-1.5-1.5-1.5s-1.5.672-1.5 1.5.672 1.5 1.5 1.5 1.5-.672 1.5-1.5z"/>
    </svg>
  );
}

export function XiaohongshuIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      ...
      role="img"
      aria-label="小红书"
      style={{ color: props.style?.color || '#FF2442', ...props.style }}
      {...props}
    >
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/>
      <path fill="white" d="M7.5 7h1.5v10H7.5V7zm2.5 0h1.5v10H10V7zm2.5 0h1.5v10h-1.5V7zm2.5 0H16v10h-1.5V7z"/>
      <path fill="white" d="M6.5 9.5h11v1H6.5v-1zm0 2h11v1H6.5v-1zm0 2h11v1H6.5v-1z"/>
      <circle fill="white" cx="8.5" cy="8" r="0.5"/>
      <circle fill="white" cy="8" cx="11" r="0.5"/>
      <circle fill="white" cy="8" cx="13.5" r="0.5"/>
      <circle fill="white" cy="8" cx="16" r="0.5"/>
    </svg>
  );
}
